...
hero:
  ...
  headline: "Bring Apple Pup Cup to Your Shop"
  subheadline: "We make it easy. No contracts, no complexity — just a wholesome product your customers and their dogs will love."
---
...
<div class="partner-highlights">
  ...
  <div class="partner-highlight">
    <div class="partner-highlight__icon">💚</div>
    <p class="partner-highlight__title">Support a Nonprofit</p>
    <p class="partner-highlight__body">Every order directly supports Kyler Family Farm Rescue & Therapy — a 501(c)(3) nonprofit.</p>
  </div>
</div>

## How to Get Started

Getting Apple Pup Cup into your shop is simple:

1. **Reach out** — send us an email with your shop name and location
2. **We'll connect** — a quick call or message to discuss your needs and find the right product mix
3. **Place your first order** — we'll handle packaging, labeling, and delivery
4. **Start serving** — hand over your first pup cup and watch the smiles happen
...
Whether you're a single-location coffee cart or a multi-location cafe group, we're ready to work with you. No inquiry is too small.
